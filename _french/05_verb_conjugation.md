...
接続法
: 文の内容は**主観的**で、**願望や要求の対象や目的**であると捉えている。
...
<table>
  ...
  <tr><td rowspan="8">直説法</td><td>現在形</td><td>今この瞬間に起きていることや習慣を述べる際に用いる。</td></tr>
  <tr><td>複合過去形</td><td>過去にしたこと、過去に起こったこと、過去の経験を述べる場合に用いる。</td></tr>
  <tr><td>半過去形</td><td>「（今は～だが以前は）～だった」というように現在と対比しながら過去の状態や状況を述べたり、「～していた」「～したものだ」と習慣的に行ったことや継続して起こったことについて述べる場合に用いる。</td></tr>
  <tr><td>単純未来形</td><td>予定を言ったり、予測をしたりといった未来に怒ることを伝えたい場合に用いる。</td></tr>
  <tr><td>大過去形</td><td>後ろに条件法過去形をつなげて、過去の事実と反する仮定文を作る際に用いる。</td></tr>
  <tr><td>前未来形</td><td>（入門本で説明なし）未来のある時点で完了している動作を表現する際に用いる。</td></tr>
  <tr><td>単純過去形</td><td>（入門本で説明なし）過去の完了した行動を述べる際に用いる。書き言葉。</td></tr>
  <tr><td>前過去形</td><td>（入門本で説明なし）過去のある時点ですでに完了している行動について述べる際に用いる。</td></tr>
  <tr><td rowspan="2">条件法</td><td>現在形</td><td>現実に反することを仮定して述べる場合に用いる。</td></tr>
  <tr><td>過去形</td><td>直接法大過去形の後ろにつなげて、過去の事実と反する仮定文を作る場合に用いる。</td></tr>
  <tr><td rowspan="4">接続法</td><td>現在形</td><td>話し手の主観を、願望や義務、および必要性を表すような表現と共に述べる場合に用いる。</td></tr>
  <tr><td>過去形</td><td>主節の表す時点よりも前に起こったことを表す際に用いる。</td></tr>
  <tr><td>半過去形</td><td>（日常会話では使わない。）</td></tr>
  <tr><td>大過去形</td><td>（日常会話では使わない。）</td></tr>
  <tr><td rowspan="2">命令法</td><td>現在形</td><td>聞き手に何らかの行動をとるように要求したり、とらないように要求する場合に用いられる。</td></tr>
...
| --- | --- | --- |
| pouvoir | /puvwar/ | ～できる |
| savoir | /savwar/| ～できる（能力を持っている） |
| devoir | /d(ə)vwar/ | ～しなければならない |
| vouloir | /vulwar/ | ～したい |
| aller | /ale/ |～するところだ、～するつもりだ |
| venir de | /v(ə)nir/ /də/ | ～したところだ |

aller は動詞としては「（～へ）行く」という意味で用いられますが、準助動詞としては近接未来形を作る道具のように用いられる。
